...
public class App {
    ...
    public static void main (String argv[])
    {
        ...
        while(itPartidos.hasNext())
            System.out.println(itPartidos.next());

        HashMap<String,Collection<Candidato>> partidos2 = new HashMap<>();
        partidos2.put("PSOE",candidatosPSOE);
        partidos2.put("PP",candidatosPP);
